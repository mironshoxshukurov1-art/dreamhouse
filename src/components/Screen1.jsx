  ...
  <div className="flex flex-col gap-6 text-white/40 text-lg">
    ...
    <FaYoutube className="hover:text-white transition-colors duration-300 cursor-pointer" />
        ...
        <main className=" max-w-7xl m-auto ">
          <div className=" absolute top-[90px] ml-[199px] pt-24 lg:pt-[60px] mx-auto lg:mx-0 lg:pl-[10%]">
            <h1 className="text-white text-5xl lg:text-7xl font-bold leading-tight"></h1>

            <img src="/slogan.svg" alt="slogan" />
          </div>
        </main>
        <div>
          <div className="relative lg:absolute lg:bottom-0 lg:right-0 z-30 w-full max-w-[440px] bg-white px-6 sm:px-10 py-8 shadow-2xl mx-auto lg:mx-0 mt-16 lg:mt-0">
