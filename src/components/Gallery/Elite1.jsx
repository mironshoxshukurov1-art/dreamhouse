  ...
  return (
    <>
      <div className="relative   min-h-screen w-full overflow-hidden bg-cover bg-center"
              style={{ backgroundImage: "url('/Group 7.jpg')"  }} >
        <Navbar onMenuClick={onMenuClick}  />

       <div className="absolute left-0 top-1/2  ml-[65px] -translate-y-1/2 z-20 hidden lg:flex flex-col items-center gap-12">
...
<img src="/points (1).png" alt="" className="" />
        </main>
